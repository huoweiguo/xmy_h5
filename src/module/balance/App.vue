...
=======
            fineBalance: '/api/static/xmy/module/fineBalance.html?userId='+xmy.getQueryString('token')+'&token='+xmy.getQueryString('userId')
>>>>>>> 97d0cbeb4554316f688dd412cbab6732bd17a5c9
        }
    },
    methods:{
        lookAmt: function(){
